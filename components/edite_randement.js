...
export default function EditeRandement({p}) {
...
const e= p.data
  ...
  const formik = useFormik({
    ...
    initialValues: {
        degree_rendement:e.degree_rendement,
    },

    onSubmit: async (values) => {
     
      await fetch('https://gestion-wheat.vercel.app/randementdetail/'+e.id+'/',{
 ...
 <Box component="form" onSubmit={formik.handleSubmit} noValidate sx={{ mt: 1 }} >
        <DialogTitle sx={row.locale === "ar"? {direction:"rtl", display:"flex", justifyContent:"center"}:{direction:'ltr', display:"flex", justifyContent:"center"}}>Edité Randement</DialogTitle>
        <DialogContent>
