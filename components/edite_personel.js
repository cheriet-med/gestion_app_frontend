...
export default function Editepersonnel({p}) {
...
const e= p.data
  ...
  const formik = useFormik({
    ...
    initialValues: {
      ...
      entre:e.entre,
      enfant:e.enfant,
      prenom_femme:e.prenom_femme,
      prenom_pere:e.prenom_pere,
      nom_mere:e.nom_mere,
      prenom_mere:e.prenom_mere,
      tel:e.tel,
    },

    onSubmit: async (values) => {
     
      await fetch('https://gestion-wheat.vercel.app/personeldetail/'+e.id+'/',{
 ...
 <Box component="form" onSubmit={formik.handleSubmit} noValidate sx={{ mt: 1 }} >
        <DialogTitle sx={row.locale === "ar"? {direction:"rtl", display:"flex", justifyContent:"center"}:{direction:'ltr', display:"flex", justifyContent:"center"}}>Edité personnel</DialogTitle>
        <DialogContent>
